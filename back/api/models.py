...
class est_m_reserva(models.Model):
    re_codigo = models.PositiveBigIntegerField(primary_key=True)
    re_fecha = models.DateField(null=False)
    re_estado = models.BooleanField(default=True, null=False)